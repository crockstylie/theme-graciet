...
if ( ! function_exists( 'understrap_theme_customize_register' ) ) {
	...
	function understrap_theme_customize_register( $wp_customize ) {
		...
		/**
		 * Libellé du bouton contact du header
		 */
		$wp_customize->add_setting(
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'main_nav_contact_button_content',
				array(
					'label'             => esc_html__( 'Libellé du bouton contact', 'understrap' ),
					'description'       => esc_html__(
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'social_bar_text_content',
				array(
					'label'             => esc_html__( 'Libellé de la barre sociale', 'understrap' ),
					'description'       => esc_html__(
						'Texte à afficher avant les icônes sociales.',
						'understrap'
					),
					'section'           => 'understrap_theme_layout_options',
		...
		/**
		 * repéteur d'url pour la barre sociale
		 */
